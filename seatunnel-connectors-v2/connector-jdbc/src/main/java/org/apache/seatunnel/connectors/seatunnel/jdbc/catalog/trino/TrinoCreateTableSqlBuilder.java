...
public class TrinoCreateTableSqlBuilder {
    ...
    public TrinoCreateTableSqlBuilder(CatalogTable catalogTable, boolean createIndex) {
    ...
    private String buildColumnSql(Column column) {
        ...
        String columnType = TrinoTypeConverter.INSTANCE.reconvert(column).getColumnType();
