...
import org.apache.seatunnel.connectors.seatunnel.jdbc.internal.dialect.trino.TrinoTypeConverter;
import org.apache.seatunnel.connectors.seatunnel.jdbc.internal.dialect.trino.TrinoTypeMapper;
...
@Slf4j
public class TrinoCatalog extends AbstractJdbcCatalog {
    ...
    protected String getCreateTableSql(
        ...
        return new TrinoCreateTableSqlBuilder(table, createIndex).build(tablePath);
    }
    ...
    protected Column buildColumn(ResultSet resultSet) throws SQLException {
        ...
        BasicTypeDefine typeDefine =
                BasicTypeDefine.builder()
                        ...
                        .build();
        return TrinoTypeConverter.INSTANCE.convert(typeDefine);
    }
    ...
    public boolean databaseExists(String databaseName) throws CatalogException {
        throw new SeaTunnelException("Not supported for list databases for trino");
    }
    ...
    public CatalogTable getTable(String sqlQuery) throws SQLException {
        ...
        return CatalogUtils.getCatalogTable(defaultConnection, sqlQuery, new TrinoTypeMapper());
    }
